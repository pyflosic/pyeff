...
dist = [0.1,0.15,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.6,0.75,1,1.25,1.5,2,3,4]
# final energies 
E = []
# bonding length 
b_len = []
...
for d in dist:
	...
	p_new = 'new.cfg'
	# new x 
	x = set_x(types,chemical_symbols,spins,x=x0,dist_nuc='3',dist_value=d,er=2)
	# write new x 
	write_cfg(p_new,types,chemical_symbols,spins,x)       
	# unit conversion 
